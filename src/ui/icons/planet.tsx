...
export const PlanetActive = (props: SvgProps) => (
  <Svg
    width={29}
    height={28}
    fill="none"
...
export const PlanetInactive = (props: SvgProps) => (
  <Svg
    width={29}
    height={28}
    fill="none"
  ...
  >
    <G
      ...
      strokeMiterlimit={10}
    >
      <Path d="M22.424 15.816c3.066 2.46 4.771 4.635 4.183 5.653-.93 1.607-7.228-.285-14.068-4.227C5.7 13.303.91 8.804 1.837 7.198c.582-1.004 3.26-.642 6.857.734" />
      <Path d="M14.222 22.666a8.333 8.333 0 1 0 0-16.666 8.333 8.333 0 0 0 0 16.666Z" />
    </G>
    <Defs>
      <ClipPath id="a">
        <Path fill="#fff" transform="translate(.722)" d="M0 0h28v28H0z" />
